...
{	
    ...
    {
        /// <summary>
        /// Springs a value from a min and max positions over time
        /// </summary>
        ...
        /// <returns></returns>
        private static float LerpRate(float rate)
        {
            rate = Mathf.Clamp01(rate);
            float invRate = - Mathf.Log(1.0f - rate, 2.0f) * 60f;
            return Mathf.Pow(2.0f, -invRate * Time.deltaTime);
        }
        ...
        {
            return Mathf.Lerp(target, value, LerpRate(rate));
        }
        ...
        /// <param name="rate"></param>
        /// <returns></returns>
        public static Vector2 Lerp(Vector2 value, Vector2 target, float rate)
        {
            return Vector2.Lerp(target, value, LerpRate(rate));
        }
        ...
        {
            return Vector3.Lerp(target, value, LerpRate(rate));
        }
        ...
        /// <param name="rate"></param>
        /// <returns></returns>
        public static Vector4 Lerp(Vector4 value, Vector4 target, float rate)
        {
            return Vector4.Lerp(target, value, LerpRate(rate));
        }
        ...
        {
            return Quaternion.Lerp(target, value, LerpRate(rate));
        }
        ...
        /// <param name="rate"></param>
        /// <returns></returns>
        public static Color Lerp(Color value, Color target, float rate)
        {
            return Color.Lerp(target, value, LerpRate(rate));
        }
        ...
        /// <param name="rate"></param>
        /// <returns></returns>
        public static Color32 Lerp(Color32 value, Color32 target, float rate)
        {
            return Color32.Lerp(target, value, LerpRate(rate));
        }
